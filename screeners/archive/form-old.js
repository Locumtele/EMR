const CONFIG = {
    screener: new URLSearchParams(window.location.search).get('screener') || 'weightloss',
    questionsEndpoint: null, // Will be set dynamically
...
// Set the questions endpoint dynamically based on screener
...
async function loadQuestions() {
    try {
        ...
        // Update subtitle with category from JSON
        if (category) {
...
document.getElementById('form').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const consultType = screenerLogic ? screenerLogic.consult : 'sync';
        const category = screenerLogic ? screenerLogic.category : CONFIG.screener;
        ...
        // Trigger redirect with telehealth logic
        const redirectData = {
            category: category,
